...
let startBtn = document.getElementById('start'),
    ...
    optionaleExpensesBtn = document.getElementsByTagName('button')[1],
    countBtn = document.getElementsByTagName('button')[2],

    optionalexpensesItem = document.querySelectorAll('.optionalexpenses-item'),
    incimeItem = document.querySelectorAll('.choose-income'),
    checkSavings = document.querySelectorAll('#saving'),
...
let appData = {
    ...
    chooseExpenses: function(){
        for (let i = 0; i < 2; i++) {
            let a = prompt('Введите обязательную статью расходов в этом месяце', 'Туалбум'),
    ...
    detectDayBudget: function(){
        ...
        alert('бюбжет на день ' + appData.moneyPerDay);
    },
    ...
    choseOptExpenses: function(){
        for (let i = 0; i < 3; i++) {
            let opt = prompt('Статья необязательных роасходов', '');
